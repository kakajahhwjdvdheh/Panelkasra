...
LOGO_INLINE = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="100%" height="100%">
<defs><linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
<stop offset="0" stop-color="#ef234f"/><stop offset="1" stop-color="#9f1239"/>
</linearGradient></defs>
<rect width="48" height="48" rx="12" fill="url(#bg)"/>
<text x="50%" y="58%" font-family="Arial, sans-serif" font-size="20" font-weight="900"
      fill="#fff" text-anchor="middle" dominant-baseline="middle">B</text>
</svg>"""
...
def get_public_page_html(uuid_key: str) -> str:
    """صفحه پابلیک گروه ساب — با نمایش سرورهای خارجی"""
    return PUBLIC_PAGE_HTML.replace("__LOGO_INLINE__", LOGO_INLINE).replace("__UUID_KEY__", uuid_key)
