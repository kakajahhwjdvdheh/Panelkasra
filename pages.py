...
/* bogzarnet Panel v2.0.0 — premium dark red / black visual system */
:root{
...
<div class="wrap">
  <div class="card">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,__LOGO_B64__" alt="bogzarnet Panel"></div>
...
<div class="modal-bg" id="modal-edit-link">
  <div class="modal">
    ...
    <div class="fg" style="margin-bottom:16px">
      <label>خروجی ترافیک (Outbound)</label>
      <select class="fs" id="el-outbound" style="width:100%">
        <option value="direct">مستقیم (Freedom)</option>
    ...
    <div class="modal-v2-body">
      ...
      <div class="modal-v2-field">
        ...
        <select class="modal-v2-input" id="no-type" onchange="onOutboundTypeChange()">
          <option value="socks5">SOCKS5 (پیشنهادی برای WARP)</option>
    ...
    <div class="modal-v2-body">
      ...
      <div id="no-fields-socks5">
        <div class="modal-v2-field">
          ...
          <input class="modal-v2-input" id="no-address" placeholder="127.0.0.1 یا server.com">
        </div>
        <div class="modal-v2-field">
          <label><i class="ti ti-route"></i> پورت</label>
          <input class="modal-v2-input" id="no-port" type="number" placeholder="1080">
        </div>
        <div class="modal-v2-field">
          <label><i class="ti ti-user"></i> یوزر (اختیاری)</label>
          <input class="modal-v2-input" id="no-username" placeholder="">
        </div>
        <div class="modal-v2-field">
          <label><i class="ti ti-key"></i> پسورد (اختیاری)</label>
          <input class="modal-v2-input" id="no-password" type="password" placeholder="">
        </div>
      </div>
      <div id="no-fields-vless" style="display:none">
        <div class="modal-v2-field">
          <label><i class="ti ti-link"></i> لینک VLESS</label>
          <input class="modal-v2-input" id="no-url" placeholder="vless://uuid@host:443?type=ws&security=tls&path=/ws/uuid">
        </div>
      </div>
      <div class="modal-v2-hint">
        <i class="ti ti-info-circle"></i>
        <span>برای WARP، معمولاً یک socks5 لوکال روی سرور (مثل 127.0.0.1:40000) بالا می‌آورید و اینجا وارد می‌کنید.</span>
      </div>
      <div class="modal-v2-footer">
        <button class="btn btn-o" onclick="closeModal('modal-create-outbound')" style="flex:.6">انصراف</button>
        <button class="btn btn-p" onclick="createOutbound()"><i class="ti ti-check"></i> ساخت</button>
      </div>
    </div>
  </div>
</div>
<div class="mob-top">
  <div class="ml">
    <div class="mob-logo"><img src="data:image/png;base64,__LOGO_B64__" alt="bogzarnet Panel"></div>
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    <div class="logo-img"><img src="data:image/png;base64,__LOGO_B64__" alt="bogzarnet Panel"></div>
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">bogzarnet Panel v2.0.0 · ساخته‌شده با دقت برای Railway</span>
    <span class="df-text">توسط تیم bogzarnet · مدیریت amirparsa</span>
...
<section class="pg" id="pg-links">
  ...
  <div class="create-panel">
    ...
    <div class="cp-body">
      ...
      <div class="cp-row mb16">
        <div class="cp-block" style="flex:1">
          <div class="cp-block-label"><i class="ti ti-route"></i> خروجی ترافیک (Outbound)</div>
          <select class="cp-input-full fs" id="nl-outbound">
            <option value="direct">مستقیم (Freedom) — پیش‌فرض</option>
            <option value="block">مسدود (Block)</option>
          </select>
          <div class="cp-footer-note" style="margin-top:8px;font-size:10px">
            <i class="ti ti-info-circle"></i>
            <span>ترافیک این کانفیگ از این خروجی عبور می‌کند. برای VLESS/SOCKS5 ابتدا از صفحه «خروجی‌ها» تعریف کنید.</span>
          </div>
        </div>
      </div>
      <div class="cp-footer">
  ...
  <div class="g2">
    <div class="srv-panel">
      ...
      <div class="srv-tiles">
        ...
        <div class="srv-tile" style="grid-column:1/-1"><div class="srv-tile-icon"><i class="ti ti-device-floppy"></i></div><div class="srv-tile-text"><div class="srv-tile-label">ذخیره‌سازی و ابزارها</div><div class="srv-tile-val">bogzarnet State · /data</div><div style="display:flex;gap:8px;margin-top:9px;flex-wrap:wrap"><button class="btn btn-o btn-sm" onclick="downloadBackup()"><i class="ti ti-download"></i> دانلود Backup</button><button class="btn btn-o btn-sm" onclick="exportActiveLinks()"><i class="ti ti-file-export"></i> Export لینک‌ها</button></div></div></div>
      </div>
    </div>
    <div class="pw-panel">
      <div class="pw-hero">
...
<section class="pg" id="pg-telegram">
  <div class="topbar"><div><div class="tb-title"><i class="ti ti-brand-telegram"></i> Telegram Bot Center</div><div class="tb-sub">مدیریت، فعال‌سازی و کنترل ربات bogzarnet از داخل پنل</div></div><div class="tb-right"><span class="badge bg-green" id="tg-status">در حال بررسی...</span></div></div>
  <div class="srv-panel tg-panel">
    <div class="srv-hero"><div class="srv-hero-icon"><i class="ti ti-robot"></i></div><div class="srv-hero-text"><div class="srv-hero-domain"> Telegram Operations</div><div class="srv-hero-sub">ساخت کانفیگ، مدیریت گروه‌های ساب و کنترل کاربران از طریق ربات</div></div></div>
  ...
  <div class="srv-panel">
    <div class="srv-hero">
      ...
      <div class="srv-hero-text">
        ...
        <div class="srv-hero-sub"><span class="dot dg pulse"></span> راه‌های ارتباطی رسمی bogzarnet</div>
      </div>
    </div>
    <div class="srv-tiles">
      <a class="srv-tile" href="https://t.me/bogzarnet" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-telegram"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">تلگرام</div><div class="srv-tile-val">@bogzarnet</div></div>
      </a>
      <a class="srv-tile" href="https://www.instagram.com/bogzarnet" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-instagram"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">اینستاگرام</div><div class="srv-tile-val">@bogzarnet</div></div>
      </a>
      <a class="srv-tile" href="https://www.youtube.com/@bogzarnet" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-youtube"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">یوتیوب</div><div class="srv-tile-val">@bogzarnet</div></div>
      </a>
      <a class="srv-tile" href="https://x.com/bogzarnet" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-x"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">توییتر / X</div><div class="srv-tile-val">@bogzarnet</div></div>
      </a>
      ...
      <a class="srv-tile" href="https://bogzarnet.ir" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-world-www"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">وب‌سایت رسمی</div><div class="srv-tile-val">bogzarnet.ir</div></div>
      </a>
      <a class="srv-tile" href="https://t.me/bogzarnet_support" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-message-circle"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">پشتیبانی مستقیم</div><div class="srv-tile-val">@bogzarnet_support</div></div>
      </a>
      <a class="srv-tile" href="mailto:bogzarnet@gmail.com" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-mail"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">ایمیل</div><div class="srv-tile-val">bogzarnet@gmail.com</div></div>
      </a>
    </div>
  </div>
</section>
...
<script>
let isDark=localStorage.getItem('bogzarnet-theme')!=='light';
...
function toggleTheme(){isDark=!isDark;localStorage.setItem('bogzarnet-theme',isDark?'dark':'light');applyTheme(isDark)}
applyTheme(isDark);
...
function applyLanguage(lang){currentLang=lang;localStorage.setItem('bogzarnet-lang',lang);document.documentElement.lang=lang;document.documentElement.dir=lang==='fa'?'rtl':'ltr';const b=document.getElementById('lang-btn');if(b)b.textContent=lang==='fa'?'EN':'فا';translatePage(lang);}
...
async function loadOutbounds(){
  try{
    ...
    document.getElementById('outbounds-nb').textContent=allOutbounds.filter(o=>!o.builtin).length;
    document.getElementById('outbounds-pg-cnt').textContent=toFa(allOutbounds.filter(o=>!o.builtin).length)+' خروجی';

    const sel=document.getElementById('nl-outbound');
    if(sel){
      const cur=sel.value;
      sel.innerHTML=allOutbounds.map(o=>
        `<option value="${esc(o.id)}">${esc(o.name)} (${esc(o.type)})</option>`
      ).join('');
      sel.value=cur||'direct';
    }
    const sel2=document.getElementById('el-outbound');
    if(sel2){
      const cur2=sel2.value;
      sel2.innerHTML=allOutbounds.map(o=>
        `<option value="${esc(o.id)}">${esc(o.name)} (${esc(o.type)})</option>`
      ).join('');
      sel2.value=cur2||'direct';
    }
        ...
        <div class="cfg-row">
          ...
          <div class="cfg-identity">
            ...
            <div class="cfg-sub-meta">
              <span class="cfg-uuid-mini">${esc(o.id).slice(0,10)}…</span>
            </div>
          </div>
          ...
          <div class="cfg-actions">
            <button class="btn btn-sm btn-d btn-icon" onclick="deleteOutbound('${o.id}')" title="حذف"><i class="ti ti-trash"></i></button>
          </div>
        </div>
      </div>
    `).join('');
...
async function deleteOutbound(id){
  if(!confirm('حذف این خروجی؟ کانفیگ‌هایی که ازش استفاده می‌کنن به direct برمی‌گردن.'))return;
  try{
    const r=await authF('/api/outbounds/'+id,{method:'DELETE'});
    if(!r.ok)throw new Error();
    toast('حذف شد ✓','ok');loadOutbounds();
  ...
  return `<div class="cfg-card ${cardCls}">
    <div class="cfg-row">
      ...
      <div class="cfg-badges-col">
        ...
        ${l.outbound_id&&l.outbound_id!=='direct'?`<span class="cfg-sub-tag" title="خروجی"><i class="ti ti-route"></i> ${esc((allOutbounds.find(o=>o.id===l.outbound_id)||{}).name||l.outbound_id)}</span>`:''}
...
async function saveEditLink(){
  ...
  const outbound_id=document.getElementById('el-outbound').value||'direct';
  const body={label,note,limit_value:val||0,limit_unit:unit,fingerprint,alpn,port,ip_limit,speed_limit_value,speed_limit_unit,outbound_id};
...
async function saveSubLinks(){
  ...
  try{
    const r=await authF('/api/subs/'+currentSubId,{
      method:'PATCH',
    ...
    console.error(e);
    toast('خطا در ذخیره کانفیگ‌های گروه','err');
  }
}
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,{LOGO_B64}" alt="bogzarnet Panel"></div>
      <div><div class="brand-name">bogzarnet</div><div class="brand-sub">Panel v2.0.0</div></div>
    </div>
  ...
  <div class="footer">پشتیبانی: <a href="https://t.me/bogzarnet" target="_blank">@bogzarnet</a> · bogzarnet Panel v2.0.0</div>
</div>
<script>
const UUID_KEY='{uuid_key}';
let savedPw='';

let isDark=localStorage.getItem('bogzarnet-pub-theme')!=='light';
function applyTheme(dark){{
  document.documentElement.setAttribute('data-theme',dark?'dark':'light');
  document.getElementById('theme-icon').className='ti '+(dark?'ti-sun':'ti-moon');
}}
function toggleTheme(){{isDark=!isDark;localStorage.setItem('bogzarnet-pub-theme',isDark?'dark':'light');applyTheme(isDark)}}
applyTheme(isDark);
    ...
    <div class="sub-info">
      ...
      <div class="sub-sub-box">
        ...
        <button class="btn btn-pur" style="padding:7px 12px;font-size:10.5px"
          onclick="navigator.clipboard.writeText(window._bogzarnetSubUrl).then(()=>toast('لینک ساب کپی شد ✓','ok'))">
          <i class="ti ti-copy"></i> کپی لینک ساب
        </button>
        <button class="btn btn-g" style="padding:7px 12px;font-size:10.5px"
          onclick="showQR(window._bogzarnetSubName + ' — کل گروه', window._bogzarnetSubUrl)">
            ...
            <div class="cfg-bottom">
              ...
              <div class="cfg-actions">
                <button class="btn btn-p"
                  onclick="navigator.clipboard.writeText(window._bogzarnetLinks[${{i}}].vless).then(()=>toast('لینک کپی شد ✓','ok'))">
                  <i class="ti ti-copy"></i> کپی لینک
                </button>
                <button class="btn btn-g"
                  onclick="showQR(window._bogzarnetLinks[${{i}}].label, window._bogzarnetLinks[${{i}}].vless)">
